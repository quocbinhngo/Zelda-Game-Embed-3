...
kernel8.img: $(BUILD_DIR)/boot.o $(OFILES) $(IMAGEOFILES) $(VIDEOOFILES) $(FONTOFILES) $(GAMEOFILES)
	aarch64-none-elf-ld $(BUILD_DIR)/boot.o $(LDFLAGS) $(OFILES) $(IMAGEOFILES) $(VIDEOOFILES) $(FONTOFILES)  $(GAMEOFILES) -T $(SRC_DIR)/link.ld -o $(BUILD_DIR)/kernel8.elf
